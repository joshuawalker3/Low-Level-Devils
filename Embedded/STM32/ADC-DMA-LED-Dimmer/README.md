...
![PWM-Response](../../../Images/STM32/ADC-DMA-LED-Dimmer/Response-Verify.png)
...
![PWM-Calc](../../../Images/STM32/ADC-DMA-LED-Dimmer/Accuracy-Verify.png)
...
Setup: ![Project Setup](../../../Images/STM32/ADC-DMA-LED-Dimmer/Setup.jpg)

## Schematic

Schematic: ![Schematic](../../../Images/STM32/ADC-DMA-LED-Dimmer/schematic.svg)

# Images

ADC Buffer when ADC is 0: ![Initial-0](../../../Images/STM32/ADC-DMA-LED-Dimmer/Initial-0.png)

ADC Buffer when ADC is 0 before processing: ![Pre-Process-0](../../../Images/STM32/ADC-DMA-LED-Dimmer/Initial-Pre-Process.png)

ADC Buffer when ADC is 0 after processing: ![After-Process-0](../../../Images/STM32/ADC-DMA-LED-Dimmer/Initial-Post-Process.png)

ADC Buffer when potentiometer in approximately the middle position: ![Mid](../../../Images/STM32/ADC-DMA-LED-Dimmer/Buffer-Mid.png)

ADC Buffer when potentiometer in max position: ![Max](../../../Images/STM32/ADC-DMA-LED-Dimmer/Buffer-Max.png)